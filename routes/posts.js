...
router.get('/detail/:postId', auth_middleware, wrapAsyncController(postsController.getOnePost)); //게시글 상세 조회
router.get('/keyword/:keyword', wrapAsyncController(postsController.searchPost)); //게시글 검색
...
router.get('/me', auth_middleware, wrapAsyncController(postsController.getMyPost)); //내가 쓴 글 조회
